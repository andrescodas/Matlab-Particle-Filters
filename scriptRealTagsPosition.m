tag = struct('tagId','32432frdes','position',[0 0]); %%initialize founded
tags = repmat(tag,1,7);
			  
% tags(1) = struct('tagId','e0040000c1b2fd01','position',[ -4.07,	   -1]); 	
% tags(2) = struct('tagId','e00400007cd7fc01','position',[ -4.07,    1.84]); 	

tags(1) = struct('tagId','e00400007cd7fc01','position',[ -4.07,	   -1]); 	
tags(2) = struct('tagId','e0040000c1b2fd01','position',[ -4.07,    1.84]); 	
...
tags(7) = struct('tagId','e004000080ddfc01','position',[ -00.84, -03.27]); 	
